...
public class SolrAPIWrapper extends AbstractAPIWrapper {
	...
	/**
	 * Below is the URL for the PostMan parameters. You should be able to paste this
	 * in and the Params will populate. Click on Body>binary and choose your file
	 * for import.
	 * 
	...
	public String otcaBatchUpdate(File update) {
		...
		if (builder != null) {
			builder.setParameter("commitWithin", "1000")
					...
					.setParameter("otca", "true").setParameter("otca.diarisation.clientMapping", "2")
			...
			try {
				...
				HttpEntity entity = EntityBuilder.create().setBinary(Files.readAllBytes(update.toPath())).build();
